...
[![Test](https://github.com/NpoolPlatform/oplog-gateway/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/oplog-gateway/actions/workflows/main.yml)
...
* make oplog-gateway ```单独编译服务```
* make oplog-gateway-image ```单独生成服务镜像```
